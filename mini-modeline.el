                      ...
                      (setq mini-modeline--cache
                            (mini-modeline--multi-lr-render
                             (if mini-modeline--msg
                               ...
                               (format-mode-line (buffer-local-value 'mini-modeline-l-format thebuffer)))
                             (format-mode-line (buffer-local-value 'mini-modeline-r-format thebuffer))))
